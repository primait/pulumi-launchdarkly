...
namespace Pulumi.Launchdarkly.Inputs
{
    ...
    public sealed class ProjectEnvironmentsArgs : global::Pulumi.ResourceArgs
    {
        [Input("apiKey")]
        ...
        public Input<Inputs.ProjectEnvironmentsApprovalSettingsArgs>? ApprovalSettings { get; set; }
        ...
        public ProjectEnvironmentsArgs()
        {
        }
        public static new ProjectEnvironmentsArgs Empty => new ProjectEnvironmentsArgs();
    }
}
