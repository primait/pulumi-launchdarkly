...
class EnvironmentApprovalSetting(dict):
    ...
    def __init__(__self__, *,
                 auto_apply_approved_changes: Optional[bool] = None,
                 ...
                 service_config: Optional[Mapping[str, str]] = None,
                 service_kind: Optional[str] = None):
        """
        :param bool auto_apply_approved_changes: Automatically apply changes that have been approved by all reviewers. This field is only applicable for approval service kinds other than `launchdarkly`.
        ...
        :param Sequence[str] required_approval_tags: An array of tags used to specify which flags with those tags require approval. You may only set `required_approval_tags` if `required` is set to `false` and vice versa.
        :param Mapping[str, str] service_config: The configuration for the service associated with this approval. This is specific to each approval service. For a `service_kind` of `servicenow`, the following fields apply:
    ...
    def auto_apply_approved_changes(self) -> Optional[bool]:
        """
    ...
    def service_config(self) -> Optional[Mapping[str, str]]:
        """
...
class FeatureFlagEnvironmentRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str context_kind: The context kind associated with the specified rollout. This argument is only valid if `rollout_weights` is also specified. Defaults to `user` if omitted.
...
class FeatureFlagEnvironmentRuleClause(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str op: The operator associated with the rule clause. Available options are `in`, `endsWith`, `startsWith`, `matches`, `contains`, `lessThan`, `lessThanOrEqual`, `greaterThanOrEqual`, `before`, `after`, `segmentMatch`, `semVerEqual`, `semVerLessThan`, and `semVerGreaterThan`. Read LaunchDarkly's [Operators](https://docs.launchdarkly.com/sdk/concepts/flag-evaluation-rules#operators) documentation for more information.
        :param Sequence[str] values: The list of values associated with the rule clause.
        :param str context_kind: The context kind associated with this rule clause. If omitted, defaults to `user`.
...
class FeatureFlagVariation(dict):
    def __init__(__self__, *,
        ...
        :param str name: The human-readable name of the feature flag.
        """
...
class FlagTriggerInstructions(dict):
    def __init__(__self__, *,
                 kind: str):
        """
        :param str kind: The action to perform when triggering. Currently supported flag actions are `turnFlagOn` and `turnFlagOff`.
        """
...
class MetricUrl(dict):
    def __init__(__self__, *,
        ...
        :param str pattern: (Required for kind `regex`) The regex pattern to match by.
        :param str substring: (Required for kind `substring`) The URL substring to match by.
        :param str url: (Required for kind `exact` and `canonical`) The exact or canonical URL.
        """
        pulumi.set(__self__, "kind", kind)
...
class ProjectEnvironment(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str key: The project-unique key for the environment. A change in this field will force the destruction of the existing resource and the creation of a new one.
        :param str name: The name of the environment.
        :param str api_key: The environment's SDK key.
        :param str client_side_id: The environment's client-side ID.
        ...
        :param str mobile_key: The environment's mobile key.
        ...
        :param Sequence[str] tags: Tags associated with your resource.
        """
...
class SegmentRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str bucket_by: The attribute by which to group contexts together.
...
class GetEnvironmentApprovalSettingResult(dict):
    def __init__(__self__, *,
                 ...
                 service_config: Mapping[str, str],
                 service_kind: str,
                 auto_apply_approved_changes: Optional[bool] = None):
        """
        :param bool can_apply_declined_changes: Set to `true` if changes can be applied as long as the `min_num_approvals` is met, regardless of whether any reviewers have declined a request. Defaults to `true`.
    ...
    @property
    @pulumi.getter(name="serviceConfig")
    def service_config(self) -> Mapping[str, str]:
        """
        The configuration for the service associated with this approval. This is specific to each approval service. For a `service_kind` of `servicenow`, the following fields apply:
