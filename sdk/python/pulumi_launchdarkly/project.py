...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key: The project's unique key. A change in this field will force the destruction of the existing resource and the creation of
               a new one.
        ...
        :param pulumi.Input[bool] include_in_snippet: Whether feature flags created under the project should be available to client-side SDKs by default. Please migrate to
