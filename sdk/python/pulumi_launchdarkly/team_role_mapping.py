...
class TeamRoleMappingArgs:
    def __init__(__self__, *,
                 custom_role_keys: pulumi.Input[Sequence[pulumi.Input[str]]],
                 team_key: pulumi.Input[str]):
        """
        ...
        :param pulumi.Input[str] team_key: The team key.
        """
    ...
    def custom_role_keys(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
    ...
    def custom_role_keys(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
        pulumi.set(self, "custom_role_keys", value)

    @property
    @pulumi.getter(name="teamKey")
    def team_key(self) -> pulumi.Input[str]:
        """
        The team key.
        """
    ...
    @team_key.setter
    def team_key(self, value: pulumi.Input[str]):
...
class _TeamRoleMappingState:
    def __init__(__self__, *,
                 ...
                 team_key: Optional[pulumi.Input[str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="teamKey")
    def team_key(self) -> Optional[pulumi.Input[str]]:
        """
        The team key.
        """
        return pulumi.get(self, "team_key")
    ...
    @team_key.setter
    def team_key(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "team_key", value)
...
class TeamRoleMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            custom_role_keys: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            team_key: Optional[pulumi.Input[str]] = None) -> 'TeamRoleMapping':
        """
    ...
    @property
    @pulumi.getter(name="customRoleKeys")
    def custom_role_keys(self) -> pulumi.Output[Sequence[str]]:
        """
        List of custom role keys the team will access. The referenced custom roles must already exist in LaunchDarkly. If they don't, the provider may behave unexpectedly.
        """
        return pulumi.get(self, "custom_role_keys")
    ...
    @property
    @pulumi.getter(name="teamKey")
    def team_key(self) -> pulumi.Output[str]:
        """
        The team key.
        """
        return pulumi.get(self, "team_key")
