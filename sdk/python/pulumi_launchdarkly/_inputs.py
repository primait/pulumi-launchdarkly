...
if not MYPY:
    class EnvironmentApprovalSettingArgsDict(TypedDict):
        auto_apply_approved_changes: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        can_apply_declined_changes: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        can_review_own_request: NotRequired[pulumi.Input[bool]]
        """
        Set to `true` if requesters can approve or decline their own request. They may always comment. Defaults to `false`.
        """
        min_num_approvals: NotRequired[pulumi.Input[int]]
        """
        ...
        """
        required_approval_tags: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        ...
        """
        service_config: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[str]]]]
        """
        ...
        """
        service_kind: NotRequired[pulumi.Input[str]]
        """
...
class EnvironmentApprovalSettingArgs:
    def __init__(__self__, *,
                 auto_apply_approved_changes: Optional[pulumi.Input[bool]] = None,
                 ...
                 service_config: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 service_kind: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[bool] auto_apply_approved_changes: Automatically apply changes that have been approved by all reviewers. This field is only applicable for approval service kinds other than `launchdarkly`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] required_approval_tags: An array of tags used to specify which flags with those tags require approval. You may only set `required_approval_tags` if `required` is set to `false` and vice versa.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] service_config: The configuration for the service associated with this approval. This is specific to each approval service. For a `service_kind` of `servicenow`, the following fields apply:
               
               	 - `template` (String) The sys_id of the Standard Change Request Template in ServiceNow that LaunchDarkly will use when creating the change request.
               	 - `detail_column` (String) The name of the ServiceNow Change Request column LaunchDarkly uses to populate detailed approval request information. This is most commonly "justification".
        :param pulumi.Input[str] service_kind: The kind of service associated with this approval. This determines which platform is used for requesting approval. Valid values are `servicenow`, `launchdarkly`. If you use a value other than `launchdarkly`, you must have already configured the integration in the LaunchDarkly UI or your apply will fail.
        """
    ...
    def auto_apply_approved_changes(self) -> Optional[pulumi.Input[bool]]:
        """
        Automatically apply changes that have been approved by all reviewers. This field is only applicable for approval service kinds other than `launchdarkly`.
        """
    ...
    def auto_apply_approved_changes(self, value: Optional[pulumi.Input[bool]]):
    ...
    def service_config(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]:
        """
        The configuration for the service associated with this approval. This is specific to each approval service. For a `service_kind` of `servicenow`, the following fields apply:
    ...
    def service_config(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]]):
...
if not MYPY:
    class FeatureFlagClientSideAvailabilityArgsDict(TypedDict):
        using_environment_id: NotRequired[pulumi.Input[bool]]
        """
        Whether this flag is available to SDKs using the client-side ID.
        """
        using_mobile_key: NotRequired[pulumi.Input[bool]]
        """
...
if not MYPY:
    class FeatureFlagEnvironmentFallthroughArgsDict(TypedDict):
        ...
        """
        rollout_weights: NotRequired[pulumi.Input[Sequence[pulumi.Input[int]]]]
        """
        ...
        """
        variation: NotRequired[pulumi.Input[int]]
        """
...
class FeatureFlagEnvironmentRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] context_kind: The context kind associated with the specified rollout. This argument is only valid if `rollout_weights` is also specified. Defaults to `user` if omitted.
...
class FeatureFlagEnvironmentRuleClauseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] op: The operator associated with the rule clause. Available options are `in`, `endsWith`, `startsWith`, `matches`, `contains`, `lessThan`, `lessThanOrEqual`, `greaterThanOrEqual`, `before`, `after`, `segmentMatch`, `semVerEqual`, `semVerLessThan`, and `semVerGreaterThan`. Read LaunchDarkly's [Operators](https://docs.launchdarkly.com/sdk/concepts/flag-evaluation-rules#operators) documentation for more information.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] values: The list of values associated with the rule clause.
        :param pulumi.Input[str] context_kind: The context kind associated with this rule clause. If omitted, defaults to `user`.
...
class FlagTriggerInstructionsArgs:
    def __init__(__self__, *,
                 kind: pulumi.Input[str]):
        """
        :param pulumi.Input[str] kind: The action to perform when triggering. Currently supported flag actions are `turnFlagOn` and `turnFlagOff`.
        """
...
if not MYPY:
    class MetricUrlArgsDict(TypedDict):
        ...
        """
        substring: NotRequired[pulumi.Input[str]]
        """
...
class MetricUrlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] pattern: (Required for kind `regex`) The regex pattern to match by.
        :param pulumi.Input[str] substring: (Required for kind `substring`) The URL substring to match by.
        :param pulumi.Input[str] url: (Required for kind `exact` and `canonical`) The exact or canonical URL.
        """
        pulumi.set(__self__, "kind", kind)
...
if not MYPY:
    class ProjectEnvironmentArgsDict(TypedDict):
        ...
        client_side_id: NotRequired[pulumi.Input[str]]
        """
        The environment's client-side ID.
        """
        confirm_changes: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        default_track_events: NotRequired[pulumi.Input[bool]]
        """
        ...
        """
        mobile_key: NotRequired[pulumi.Input[str]]
        """
        The environment's mobile key.
        """
        require_comments: NotRequired[pulumi.Input[bool]]
        """
        Set to `true` if this environment requires comments for flag and segment changes. This field will default to `false` when not set.
        """
        secure_mode: NotRequired[pulumi.Input[bool]]
        """
...
class ProjectEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] critical: Denotes whether the environment is critical.
...
if not MYPY:
    class SegmentRuleArgsDict(TypedDict):
        ...
        List of nested blocks specifying the logical clauses to evaluate
        """
        rollout_context_kind: NotRequired[pulumi.Input[str]]
        """
...
class SegmentRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] bucket_by: The attribute by which to group contexts together.
...
class TeamMemberRoleAttributeArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[str]]]):
        """
        :param pulumi.Input[str] key: The key / name of your role attribute. In the example `$${roleAttribute/testAttribute}`, the key is `testAttribute`.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] values: A list of values for your role attribute. For example, if your policy statement defines the resource `"proj/$${roleAttribute/testAttribute}"`, the values would be the keys of the projects you wanted to assign access to.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "values", values)
...
class GetTeamMemberRoleAttributeArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[str]):
        """
        :param str key: The key / name of your role attribute. In the example `$${roleAttribute/testAttribute}`, the key is `testAttribute`.
        :param Sequence[str] values: A list of values for your role attribute. For example, if your policy statement defines the resource `"proj/$${roleAttribute/testAttribute}"`, the values would be the keys of the projects you wanted to assign access to.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "values", values)
