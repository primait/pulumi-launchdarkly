...
class CustomRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key: A unique key that will be used to reference the custom role in your code. A change in this field will force the destruction of the existing resource and the creation of a new one.
        ...
        :param pulumi.Input[str] name: A name for the custom role. This must be unique within your organization.
